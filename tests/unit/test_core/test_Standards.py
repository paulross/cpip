...
def test_help_text():
    ...
    # print(help_text)
    assert help_text == [
        'For K&R (The C Programming Language, Kernighan and Ritchie, First Edition, ISBN 9780131101630) Use: --std=k&r.',
        'For ANSI (ANSI X3.159-1989) Use: --std=ansi, --std=c89.',
        'For C90 (ISO/IEC 9899:1990) Use: --std=c90, --std=iso9899:1990, --std=iso9899:199409.',
        'For C95 (ISO/IEC 9899-1:1994, ISO/IEC 9899:1990/AMD1:1995) Use: --std=c95.',
        'For C99 (ISO/IEC 9899:1999) Use: --std=c99, --std=c9x, --std=iso9899:1999, --std=iso9899:199x.',
        'For C11 (ISO/IEC 9899:2011) Use: --std=c11, --std=c1x, --std=iso9899:2011.',
        'For C17/C18 (ISO/IEC 9899:2018) Use: --std=c17, --std=c18, --std=iso9899:2017, --std=iso9899:2018.',
