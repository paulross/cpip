...
class TestExpressionLexLiteral(TestPpTokeniserBase):
    ...
    def testLexLiteral(self):
        ...
        # Special
        myObj.resetTokType()
        myStr = """\"  New class `%s' (sec=0x%08x)! #tArgLists=%d\\n",
...
class TestPpTokeniserLinux(TestPpTokeniserBase):
    ...
    def test_00(self):
        ...
        myStr = """#ifndef _ASM_X86_ALTERNATIVE_H
...
#endif  /* __assembler */
"""
        myStr = """#if     !__STDC__ && !defined (__cplusplus)
/* Non-ANSI name for compatibility */
#define complex _complex
#endif
