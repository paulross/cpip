..
    Sadly this does not work as it references things like:
    .. image:: https://img.shields.io/pypi/v/cpip.svg
    And latex does not like SVG.
    Nesting those commands in:
    .. only:: html
    Does not work either as PyPi long_description complains about unknown command ".. only:: html"
    .. include:: ../../README.rst

    So we resort to copy/past ../../README.rst here without the images in the "Status" section.
